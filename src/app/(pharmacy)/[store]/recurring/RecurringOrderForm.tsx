  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm border">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <input name="patientName" required placeholder="Patient Name" className="w-full px-3 py-2 border rounded-lg text-sm" />
        <input name="patientPhone" placeholder="Phone (optional)" className="w-full px-3 py-2 border rounded-lg text-sm" />
        <input name="deliveryAddress" required placeholder="Address" className="w-full px-3 py-2 border rounded-lg text-sm" />
        <div className="grid grid-cols-2 gap-2">
          <input name="deliveryCity" required placeholder="City" className="w-full px-3 py-2 border rounded-lg text-sm" />
          <input name="deliveryPostalCode" required placeholder="Postal Code" className="w-full px-3 py-2 border rounded-lg text-sm" />
        </div>
