              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center space-x-2">
                    <span
                      className={`inline-block w-2 h-2 rounded-full ${n.type === "DELIVERY_FAILED" ? "bg-rose-500" : n.type === "ORDER_PICKED_UP" ? "bg-teal-500" : "bg-sky-500"}`}
                    />
                    <span className={statusBadgeClasses(n.type === "DELIVERY_FAILED" ? "FAILED" : n.type === "ORDER_PICKED_UP" ? "PICKED_UP" : "IN_TRANSIT")}>
